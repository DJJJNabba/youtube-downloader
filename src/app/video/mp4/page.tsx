    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      ...
      <div className="relative max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
          <div className="bg-gradient-to-r from-green-500 via-emerald-600 to-teal-600 px-8 py-12">
            <div className="flex items-center space-x-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-white mb-2">Video to MP4</h1>
                <p className="text-green-100 text-lg">Download high-quality videos from YouTube</p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 text-center">
            ...
            <p className="text-sm font-medium text-gray-900">High Quality MP4</p>
          </div>
        </div>
      </div>
    </div>
